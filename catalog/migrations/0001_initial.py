# Generated by Django 3.1.2 on 2022-03-23 06:08
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='News',
            fields=[
                ('title', models.CharField(help_text='Enter the title of the news', max_length=100, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stock_code', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='catalog.stock')),
            ],
            options={
                'ordering': ['stock_code', 'date_time', 'price'],
            },
        ),
    ]
